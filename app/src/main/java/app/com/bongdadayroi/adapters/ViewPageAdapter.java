...
public class ViewPageAdapter extends PagerAdapter {
    ...
    public ViewPageAdapter(Context context, GetInfoVideo getInfoVideo, String video_id, MyLogin myLogin) {
        mContext = context;
    ...
    private void setUpListComment(final ViewGroup layout, final String video_id) {
        ...
        ivMySend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(content.equals("")){
                    Toast.makeText(mContext, "Vui lòng nhập nội dung bình luận!", Toast.LENGTH_SHORT).show();
                }else{
                    comment(content);
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        if(myData.getArrayRelate().size()>0){
                            MyAdapter.getInstance().setMyListAdapter(new MyListAdapter(mContext, myData.getArrayRelate()));
                            listviewRelate.setAdapter(MyAdapter.getInstance().getMyListAdapter());
                            ScreenSize.RELATE_HEIGHT = SetHeightView.setListViewHeightBasedOnChildren(listviewRelate, 0);
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        if(myData.getArrayComment().size()>0){
                            MyAdapter.getInstance().setCommentAdapter(new CommentAdapter(mContext, myData.getArrayComment()));
                            ...
                            getInfoVideo.setHeightView(SetHeightView.setListViewHeightBasedOnChildren(listviewComment, baseHeight));
                        }else{
