...
public class MyRequest {
    public static void requestHomeAPI(final AppCompatActivity context,
                                      final SplashError splashError) {
    ...
    public static void requestNewAPI(final AppCompatActivity context,
                                     final SplashError splashError) {
    ...
    public static void requestMostAPI(final AppCompatActivity context,
                                      final SplashError splashError) {
    ...
    public static synchronized void sendSimpleRequest(final AppCompatActivity context,
                                                      final SplashError splashError) {
...
//                        Toast.makeText(context, "" + category.getData().length, Toast.LENGTH_SHORT).show();
    ...
    public static void requestGetToken(final Context context, final String fa_access_token,
                                       final GetInfoAccount getInfoAccount) {
